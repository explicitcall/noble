...
export declare function startScanning(callback?: (error?: Error) => void): Promise<void>;
export declare function startScanning(serviceUUIDs: string[], callback?: (error?: Error) => void): Promise<void>;
export declare function startScanning(serviceUUIDs: string[], allowDuplicates: boolean, callback?: (error?: Error) => void): Promise<void>;
export declare function stopScanning(callback?: () => void): Promise<void>;
...
export declare class Peripheral extends events.EventEmitter {
  ...
  connect(callback?: (error: string) => void): Promise<void>;
  disconnect(callback?: () => void): Promise<void>;
  updateRssi(callback?: (error: string, rssi: number) => void): Promise<number>;
  discoverServices(serviceUUIDs: string[], callback?: (error: string, services: Service[]) => void): Promise<Service[]>;
  discoverAllServicesAndCharacteristics(callback?: (error: string, services: Service[], characteristics: Characteristic[]) => void):
    Promise<{ services: Service[]; characteristics: Characteristic[]; }>;
  discoverSomeServicesAndCharacteristics(serviceUUIDs: string[], characteristicUUIDs: string[], callback?: (error: string, services: Service[], characteristics: Characteristic[]) => void):
    Promise<{ services: Service[]; characteristics: Characteristic[]; }>;

  readHandle(handle: Buffer, callback: (error: string, data: Buffer) => void): Promise<Buffer>;
  writeHandle(handle: Buffer, data: Buffer, withoutResponse: boolean, callback: (error: string) => void): Promise<void>;
  toString(): string;
...
export declare class Service extends events.EventEmitter {
  ...
  discoverIncludedServices(serviceUUIDs: string[], callback?: (error: string, includedServiceUuids: string[]) => void): Promise<string[]>;
  discoverCharacteristics(characteristicUUIDs: string[], callback?: (error: string, characteristics: Characteristic[]) => void): Promise<Characteristic[]>;
  toString(): string;
...
export declare class Characteristic extends events.EventEmitter {
  ...
  read(callback?: (error: string, data: Buffer) => void): Promise<Buffer>;
  write(data: Buffer, notify: boolean, callback?: (error: string) => void): Promise<void>;
  broadcast(broadcast: boolean, callback?: (error: string) => void): Promise<void>;
  notify(notify: boolean, callback?: (error: string) => void): Promise<void>;
  discoverDescriptors(callback?: (error: string, descriptors: Descriptor[]) => void): Promise<Descriptor[]>;
  toString(): string;
...
export declare class Descriptor extends events.EventEmitter {
  ...
  readValue(callback?: (error: string, data: Buffer) => void): Promise<Buffer>;
  writeValue(data: Buffer, callback?: (error: string) => void): Promise<void>;
  toString(): string;
